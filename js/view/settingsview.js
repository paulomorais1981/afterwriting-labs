define(function(require){
    ...
    var $ = require('jquery'),
        ...
        template = require('text!../../html/template/settings.html');
    ...
    var SettingsView = TemplateView.extend({
        ...
        init: function() {
    		...
    		this.$$('input, option').on('change keyup', function() {
			    this.components_to_data();
		    }.bind(this));
		    
		    // TODO: add activate() to the plugin
		    this.settings.activate.add(function() {
			    this.data_to_components();
		    }.bind(this));
        },
        
    	data_to_components: function() {
			var c = this.settings.get_config();
			var $ = this.$$.bind(this);
