...
require.config({
    ...
    use_node_require: ['jquery', 'fs', 'protoplast', 'd3', 'off']
});
            ...
            load_config(ops.config, function(config) {
                ...
                if (ops.pdf) {
                    validate_pdf(function() {
                        ...
                        pdfmaker.get_pdf(data.script.lines, data.script.config, data.script.title_token.bind(data.script), data.fontFixEnabled, function() {
                            console.log('Done!');
                            process.exit(0);
                        }, ops.pdf);
                    });
